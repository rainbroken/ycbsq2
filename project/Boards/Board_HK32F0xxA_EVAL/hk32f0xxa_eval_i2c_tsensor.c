...
* @filename:  hk32f0xxa_eval_i2c_tsensor.c
* @brief:     This file provides a set of functions needed to manage the I2C LM75
*             temperature sensor mounted on HK32F0xxA-EVAL board.
*             It implements a high level communication layer for read and write
*             from/to this sensor. The needed HK32F0xxA hardware resources (I2C and
*             GPIO) are defined in hk32f0xxa_eval.h file, and the initialization is
*             performed in LM75_LowLevel_Init() function declared in hk32f0xxa_eval.c
*             file.
...
/** @defgroup HK32F0xxA_EVAL_I2C_TSENSOR_Private_Functions
  * @{
  */
