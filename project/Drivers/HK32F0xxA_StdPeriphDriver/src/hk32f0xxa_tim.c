...
* @filename:  hk32f0xxa_tim.c
* @brief:     This driver provides functions to configure and program the TIM.
* @author:    AE Team
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 15, 16 or 17 to select the TIMx peripheral
                             ...
                             uint16_t ExtTRGFilter)
{
    ...
    tmpsmcr &= (uint32_t)(~((uint32_t)(TIM_SMCR_TS2_0 | TIM_SMCR_TS5_3)));
    tmpsmcr |= TIM_TS_ETRF;
    /* Write to TIMx SMCR */
    TIMx->SMCR = tmpsmcr;
}
...
/**
  ...
  *            @arg TIM14_HSEDiv32: TIM14 Channel 1 is connected to HSE/32 clock.
