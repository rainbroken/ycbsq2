  ...
  *
  ...
  ===============================================================================
    [..] This driver provides functions to configure and program the Flash
         memory of all HK32F0xxA devices. These functions are split in 4 groups
...
/**
  * @brief  Enables or disables the PREEMPTDIS.
  * @param  NewState: new state of the PREEMPTDIS.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void FLASH_ConfigPReemptdis(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    ...
    if (NewState != DISABLE)
    {
        FLASH->ECR &= ~FLASH_ECR_PREEMPTDIS;
    }
    else
    {
        FLASH->ECR |= FLASH_ECR_PREEMPTDIS;
...
/**
  * @brief  Enables or disables the PRepgen.
  * @param  NewState: new state of the PRepgen.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void FLASH_ConfigPRepgen(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  * @brief  Enables or disables the LPRDE.
  * @param  NewState: new state of the LPRDE.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void FLASH_ConfigLPRDE(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 *
 ...
 ===============================================================================
    ...
    [..] The FLASH_Option Bytes Programming_functions, includes the following functions:
       ...
       (+) FLASH_OBProgramData(uint32_t Address, uint8_t Data);
    ...
    (#) Call the FLASH_OBUnlock() function to enable the Option Bytes registers access

    (#) Call one or several functions to program the desired option bytes
      (++) FLASH_Status FLASH_OBRDPConfig(uint8_t OB_RDP) => to set the desired read Protection Level
      (++) FLASH_Status FLASH_OB_WRPConfig(uint32_t OB_WRP, FunctionalState NewState)
      ...
      (++) You can write all User Options bytes at once using a single function
           by calling FLASH_Status FLASH_OBWriteUser(uint8_t OB_USER)
      (++) FLASH_OBProgramData(uint32_t Address, uint8_t Data) to program the
           two half word in the option bytes

    (#) Once all needed option bytes to be programmed are correctly written, call the
      FLASH_OBLaunch(void) function to launch the Option Bytes programming process.

    (#) Call the FLASH_OBLock() to disable the Option Bytes registers access (recommended
...
/**
  ...
  *            @arg OB_WRP_Pages0to3..OB_WRP_Pages120to123
  *            @arg OB_WRP_AllPages
  * @retval FLASH Status: The returned value can be:
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
...
/**
  ...
  * @param  NewState: new state of the FLASH IT buffer.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
