...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
    ...
    I2Cx->OAR1 |= (I2C_OAR1_OA1EN | tmpreg);
...
/**
  * @brief  Enables or disables the swap SDA/SCL pins.
  * @param  I2Cx: where x can be from 1 to 2 to select the I2C peripheral.
  * @param  NewState: new state of the I2Cx SDA/SCL pins pinout.
...
void I2C_SWAPPinCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != DISABLE)
    {
        ...
        I2Cx->CR1 |= I2C_CR1_SWAP;
    }
    else
    {
        /* Disable the SWAP feature by clearing the SWAP bit in the CR2 register */
        I2Cx->CR1 &= (uint32_t)~((uint32_t)I2C_CR1_SWAP);
    }
}
