...
@verbatim
 ...
 ===============================================================================
    ...
    [..] The read access of the SPI_DR register can be done using
         ...
         SPI_I2SReceiveData16() (when data size is superior than 8bits)function
         ...
         and SPI_I2SSendData16() (when data size is superior than 8bits) function
...
/**
  ...
  * @retval None
  */
void SPI_I2SSendData16(SPI_TypeDef* SPIx, uint16_t Data)
{
    /* Check the parameters */
    assert_param(IS_SPI_ALL_PERIPH(SPIx));
...
/**
  ...
  * @retval The value of the received data.
  */
uint16_t SPI_I2SReceiveData16(SPI_TypeDef* SPIx)
{
    return SPIx->DR;
}
/**
...
@verbatim
 ...
 ===============================================================================
    ...
    -@-
       ...
       SPI bandwidth.
       (+@) When the hk32 are configured as slaves and the NSS hardware mode is
...
/**
  ...
  *         a read operation to SPI_SR register (SPI_I2SGetFlagStatus()).
  * @note   MODF (Mode Fault) flag is cleared by software sequence: a read/write
  *         operation to SPI_SR register (SPI_I2SGetFlagStatus()) followed by
