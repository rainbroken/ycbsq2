  ...
  * @{
  ...
  ==============================================================================
    ...
    [..] Min-max timeout value @40KHz (LSI): ~0.1ms / ~28.3s
         The IWDG timeout may vary due to LSI frequency dispersion. HK32F0xxA
         ...
         For more information, please refer to the HK32F0xxA Reference manual.
