...
#ifndef __HK32F0XXA_RTC_H
#define __HK32F0XXA_RTC_H
...
/** @defgroup RTC_Exported_Types RTC_Exported_Types
  * @{
  */
/**
...
/** @defgroup RTC_Wakeup_Timer_Definitions RTC_Wakeup_Timer_Definitions
  * @brief    These parameters are available for all devices
  * @{
  */
...
#define IS_RTC_GET_FLAG(FLAG) (((FLAG) == RTC_FLAG_TSOVF)  || ((FLAG) == RTC_FLAG_TSF)     || \
                               ((FLAG) == RTC_FLAG_WUTF)   || ((FLAG) == RTC_FLAG_INITF)   || \
                               ((FLAG) == RTC_FLAG_ALRAWF) || ((FLAG) == RTC_FLAG_ALRBWF)  || \
                               ((FLAG) == RTC_FLAG_ALRAF)  || ((FLAG) == RTC_FLAG_ALRBF)   || \
                               ((FLAG) == RTC_FLAG_RSF)    || ((FLAG) == RTC_FLAG_WUTWF)   || \
                               ((FLAG) == RTC_FLAG_TAMP1F) || ((FLAG) == RTC_FLAG_TAMP2F)  || \
                               ((FLAG) == RTC_FLAG_SHPF) || ((FLAG) == RTC_FLAG_RECALPF))

#define IS_RTC_CLEAR_FLAG(FLAG) (((FLAG) != (uint32_t)RESET) && (((FLAG) & 0xFFFF80DF) == (uint32_t)RESET))
