...
#ifndef __HK32F0XXA_USART_H
#define __HK32F0XXA_USART_H
...
#define USART_WordLength_7b                  ((uint32_t)0x10000000)
...
/** @defgroup USART_DMA_Recception_Error  USART_DMA_Recception_Error
  * @{
  */
...
/** @defgroup USART_StopMode_WakeUp_methods  USART_StopMode_WakeUp_methods
  * @{
  */
...
/** @defgroup USART_Global_definition  USART_Global_definition
  * @{
  */
