...
#ifndef __HK32F0XXA_CAN_H
#define __HK32F0XXA_CAN_H
...
/** @defgroup CAN_Exported_Types CAN_Exported_Types
  * @{
  */
/**
...
typedef struct
{
    ...
    uint8_t CAN_Mode;         /*!< Specifies the CAN mode.
