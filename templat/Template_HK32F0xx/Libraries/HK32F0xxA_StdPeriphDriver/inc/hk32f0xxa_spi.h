...
#ifndef __HK32F0XXA_SPI_H
#define __HK32F0XXA_SPI_H
...
/** @defgroup SPI_Constants SPI_Constants
  * @{
  */
...
/** @defgroup SPI_Exported_Functions SPI_Exported_Functions
  * @{
  */
