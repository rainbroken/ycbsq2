...
* @filename:  hk32f0xxa_eval_spi_flash.c
* @brief:     This file provides a set of functions needed to manage the SPI M25Pxxx
*             FLASH memory mounted on HK32F0xxA_EVAL board (refer to HK32F0xxA_EVAL.h
...
*             performed in sFLASH_LowLevel_Init() function declared in hk32f0xxa_eval.c
*             file.
...
/** @addtogroup HK32F0xxA_EVAL_SPI_FLASH
  * @brief      This file includes the M25Pxxx SPI FLASH driver of HK32-EVAL boards.
  * @{
  */
...
/** @defgroup HK32F0xxA_EVAL_SPI_FLASH_Private_Functions
  * @{
  */
