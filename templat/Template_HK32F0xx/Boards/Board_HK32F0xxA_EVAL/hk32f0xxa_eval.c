...
* @filename:  hk32f0xxa_eval.c
* @brief:     This file provides firmware functions to manage Leds, push-buttons,
*             COM ports, SD card on SPI and temperature sensor (LM75) available on
*             HK32F0xxA-EVAL evaluation board from HKMicroelectronics.
* @author:    AE Team
...
/** @defgroup HK32F0xxA_EVAL_LOW_LEVEL
  * @brief This file provides firmware functions to manage Leds, push-buttons,
  *        COM ports, SD card on SPI and temperature sensor (LM75) available on
  *        HK32F0xxA-EVAL evaluation board from HKMicroelectronics.
  * @{
...
/** @defgroup HK32F0xxA_EVAL_LOW_LEVEL_Private_Functions
  * @{
  */
...
{
    /* There is no Wakeup button on HK32F0xxA-EVAL. */
...
void SD_LowLevel_DeInit(void)
{
    ...
    SPI_I2SDeInit(SD_SPI);   /* DeInitializes the SD_SPI */
