 ...
 * @version       1.0
 * @datatime      2021-05-24 10:10:12(GMT+8:00)
...
/************************ HK32F0xx specific Interrupt Numbers  **************************/
  ...
  CAN_IRQn                   = 30, /* CAN gobal interrupts */
...
*****************************************************************************************/
typedef struct{
  __I  uint16_t ISR;                    /* Interrupt and Status Register */
       uint16_t RESERVED1;
  ...
  __IO uint16_t CR;                     /* Control Register */
       uint16_t RESERVED4;
  __IO uint16_t CMP;                    /* Compare Register */
       uint16_t RESERVED5;
  __IO uint16_t ARR;                    /* Autoreload Register */
       uint16_t RESERVED6;
  __I  uint16_t CNT;                    /* Counter Register */
       uint16_t RESERVED7[3];
  __IO uint16_t CFGR2;                  /* Configuration Register 2 */
}LPTIM_TypeDef;
