...
/** @defgroup DMA_Group1 Initialization_And_Configuration Initialization_And_Configuration
...
/** @defgroup DMA_Group2 Data_Counter Data_Counter
...
/** @defgroup DMA_Group3 Interrupts_And_Flags_Management Interrupts_And_Flags_Management
...
/**
  ...
  *            @arg DMA1_FLAG_GL6: DMA Channel6 global flag.
  *            @arg DMA1_FLAG_TC6: DMA Channel6 transfer complete flag.
  *            @arg DMA1_FLAG_HT6: DMA Channel6 half transfer flag.
  *            @arg DMA1_FLAG_TE6: DMA Channel6 transfer error flag.
  *            @arg DMA1_FLAG_GL7: DMA Channel7 global flag.
  *            @arg DMA1_FLAG_TC7: DMA Channel7 transfer complete flag.
  *            @arg DMA1_FLAG_HT7: DMA Channel7 half transfer flag.
  *            @arg DMA1_FLAG_TE7: DMA Channel7 transfer error flag.
...
/**
  ...
  * @param  DMAy_IT: specifies the DMA interrupt source to check.
  *         This parameter can be one of the following values:
...
/**
  ...
  * @param  DMAy_IT: specifies the DMA interrupt pending bit to clear.
  *         This parameter can be any combination (for the same DMA) of the following values:
  *            @arg DMA1_IT_GL1: DMA1 Channel1 global interrupt.
  *            @arg DMA1_IT_TC1: DMA1 Channel1 transfer complete interrupt.
  *            @arg DMA1_IT_HT1: DMA1 Channel1 half transfer interrupt.
...
void DMA_ClearITPendingBit(uint32_t DMAy_IT)
{
    ...
    if ((DMAy_IT & FLAG_Mask) == (uint32_t)RESET)
    {
        switch (DMAy_IT)
        {
            ...
            case DMA1_IT_GL6:
                DMA1->IFCR = DMA1_IT_TC6 | DMA1_IT_HT6 | DMA1_IT_TE6;
                break;

            case DMA1_IT_GL7:
                DMA1->IFCR = DMA1_IT_TC7 | DMA1_IT_HT7 | DMA1_IT_TE7;
                break;
