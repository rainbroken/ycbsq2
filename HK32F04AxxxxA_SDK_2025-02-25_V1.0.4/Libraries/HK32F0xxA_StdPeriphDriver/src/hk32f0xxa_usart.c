...
/** @defgroup USART_PERIPH_Constants  USART_PERIPH_Constants
  * @{
  */
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
...
/**
  * @brief  Selects the USART WakeUpSource method form stop mode.
 ...
 *** Polling Mode ***
 ====================
    [..] In Polling Mode, the SPI communication can be managed by these flags:
         ...
         (#) USART_FLAG_LBDF: to indicate the status of the LIN break detection.
