...
* @filename:  hk32f0xxa_rcc.c
* @brief:     This file provides all the RCC firmware functions.
* @author:    AE Team
* @version:   V1.0.1/2024-06-13
*             1.Modify RCC_I2CCLKConfig function
* @log:       V1.0.0/2023-10-08
*             1.Initial version
*******************************************************************************/
...
/**
  ...
  *         HSE_STARTUP_TIMEOUT in hk32f0xxa.h file. You can tailor it depending
...
/**
  ...
  * @note   The HSI56 is stopped by hardware when entering STOP and STANDBY modes.
...
/**
  ...
  *            @arg RCC_PLLMul_2: PLL multiplication factor
  *            @arg RCC_PLLMul_16:PLL multiplication factor
...
/**
  ...
  *            @arg RCC_SYSCLKSource_HSI14:  HSI14 selected as system clock source
...
uint8_t RCC_GetSYSCLKSource(void)
{
    ...
    //RCC_CFGR.SWS set SYSCLK
    if (tmp == 0)
    {
        return ((uint8_t)(RCC->CFGR & RCC_CFGR_SWS)) >> 2;
    }
    else //RCC_CFGR4.ESWS set SYSCLK
    {
...
/**
  ...
  * @param  RCC_USART2CLK: defines the USART clock source. This clock is derived
  *         from the HSI or System clock.
  *         This parameter can be one of the following values:
...
{
    /* Check the parameters */
    assert_param(IS_RCC_USARTCLK(RCC_USART2CLK));
    /* Clear USART2SW bit */
    RCC->CFGR3 &= ~RCC_CFGR3_USART2SW;
    /* Set USART2SW bits according to RCC_USART2CLK value */
    RCC->CFGR3 |= RCC_USART2CLK << RCC_CFGR3_USART2SW_Pos;
}

/**
  * @brief  Configures the USART1 clock (USART1CLK).
  * @param  RCC_USART1CLK: defines the USART clock source. This clock is derived
  *         from the HSI or System clock.
  *         This parameter can be one of the following values:
...
{
    /* Check the parameters */
    assert_param(IS_RCC_USARTCLK(RCC_USART1CLK));
    /* Clear USART1SW bit */
    RCC->CFGR3 &= ~RCC_CFGR3_USART1SW;
    /* Set USART1SW bits according to RCC_USART1CLK value */
    RCC->CFGR3 |= RCC_USART1CLK << RCC_CFGR3_USART1SW_Pos;
}
/**
  * @brief  Configures the LPUART clock (LPUART1CLK).
  * @param  RCC_LPUARTCLK: defines the USART clock source. This clock is derived
  *         from the HSI or System clock.
  *         This parameter can be one of the following values:
  *            @arg RCC_LPUART1CLK_PCLK: LPUART clock = APB Clock (PCLK)
  *            @arg RCC_LPUART1CLK_SYSCLK: LPUART clock = System Clock
  *            @arg RCC_LPUART1CLK_LSE: LPUART clock = LSE Clock
  *            @arg RCC_LPUART1CLK_HSI: LPUART clock = HSI Clock
  * @retval None
  */
void RCC_LPUARTCLKConfig(uint32_t RCC_LPUARTCLK)
{
    ...
    /* Clear LPUART1SW bit */
    RCC->CFGR6 &= ~RCC_CFGR6_LPUART1SW;
    /* Set LPUART1SW bits according to RCC_LPUART1CLK value */
    RCC->CFGR6 |= RCC_LPUARTCLK << RCC_CFGR6_LPUART1SW_Pos;
}
...
/**
  ...
  *            @arg RCC_LPTIMCLK_SYSCLK: LPTIM clock = System Clock
  *            @arg RCC_LPTIMCLK_LSE: LPTIM clock = LSE Clock
  *            @arg RCC_LPTIMCLK_HSI: LPTIM clock = HSI Clock
  * @retval None
  */
void RCC_LPTIMCLKConfig(uint32_t RCC_LPTIMCLK)
{
    ...
    /* Clear LPTIMSW bit */
    RCC->CFGR6 &= ~RCC_CFGR6_LPTIM1SW;
    /* Set LPTIMSW bits according to LPTIMCLK value */
    RCC->CFGR6 |= RCC_LPTIMCLK << RCC_CFGR6_LPTIM1SW_Pos;
}
...
/**
  ...
  * @note   (*) HSI_VALUE is a constant defined in HK32f0xxa.h file (default value
  *         8 MHz) but the real value may vary depending on the variations
  *         in voltage and temperature, refer to RCC_AdjustHSICalibrationValue().
  * @note   (**) HSE_VALUE is a constant defined in HK32f0xxa.h file (default value
...
{
    uint32_t tmp = 0, tmp1 = 0, pllmull = 0, pllsource = 0, prediv1factor = 0, presc = 0, pllppss = 0;
    //clock source
    tmp1 = (RCC->CFGR4 & RCC_CFGR4_ESSS) >> 7;

    //RCC_CFGR.SW to set SYSCLK
    if (tmp1 == 0)
    {
        /* Get SYSCLK source -------------------------------------------------------*/
        ...
        switch (tmp)
        {
            ...
            case 0x08:  /* PLL used as system clock */
                ...
                {
                    prediv1factor = RCC->CFGR2 & RCC_CFGR2_PREDIV_Mask;
                    prediv1factor += 1;
                    ...
                    if (pllppss == 0)
                    {
                        RCC_Clocks->SYSCLK_Frequency = (HSE_VALUE * pllmull) / prediv1factor;
                    }
                    else//HSI 8M
                    {
                        RCC_Clocks->SYSCLK_Frequency = (HSI_VALUE * pllmull) / prediv1factor;
                    }
                }

                break;

            case 0x0C:  /* HSI56 used as system clock */
                RCC_Clocks->SYSCLK_Frequency = HSI56_VALUE;
                break;
    ...
    else if (tmp1 == 1) //RCC_CFGR4.ESW to set SYSCLK
    {
        /* Get SYSCLK source -------------------------------------------------------*/
        tmp = (RCC->CFGR4 & RCC_CFGR4_ESWS);

        switch (tmp)
        {
            case 0x00:  /* LSE used asSYSCLK */
                RCC_Clocks->SYSCLK_Frequency = LSE_VALUE;
                break;

            case 0x08:  /* LSI used asSYSCLK */
                RCC_Clocks->SYSCLK_Frequency = LSI_VALUE;
                break;

            case 0x10:  /* HSI56MHz RC used asS YSCLK */
                RCC_Clocks->SYSCLK_Frequency = HSI56_VALUE;
                break;

            case 0x18:  /* HSI14 used as SYSCLK */
                RCC_Clocks->SYSCLK_Frequency = HSI14_VALUE;
                break;

            case 0x20:  /*EXTCLK used as SYSCLK */
    ...
    if ((RCC->CFGR4 & RCC_CFGR4_I2C2CLK_SEL) == 0x0)
    {
        /* I2C2 Clock is PCLK Clock */
        RCC_Clocks->I2C2CLK_Frequency = RCC_Clocks->PCLK_Frequency;
    }
    else if ((RCC->CFGR4 & RCC_CFGR4_I2C2CLK_SEL) == RCC_CFGR4_I2C2CLK_SEL_0)
    {
    ...
    else if ((RCC->CFGR4 & RCC_CFGR4_I2C2CLK_SEL) == RCC_CFGR4_I2C2CLK_SEL)
    {
        /* I2C2 Clock is PCLK Clock */
        RCC_Clocks->I2C2CLK_Frequency = RCC_Clocks->PCLK_Frequency;
    }
    ...
    if ((RCC->CFGR6 & RCC_CFGR6_LPUART1SW) == 0x0)
    {
        /* LPUART1CLK Clock is PCLK */
        RCC_Clocks->LPUART1CLK_Frequency = RCC_Clocks->PCLK_Frequency;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPUART1SW) == RCC_CFGR6_LPUART1SW_0)
    {
        /* LPUART1CLK Clock is System Clock */
        RCC_Clocks->LPUART1CLK_Frequency = RCC_Clocks->SYSCLK_Frequency;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPUART1SW) == RCC_CFGR6_LPUART1SW_1)
    {
        /* LPUART1CLK Clock is LSE Osc. */
        RCC_Clocks->LPUART1CLK_Frequency = LSE_VALUE;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPUART1SW) == RCC_CFGR6_LPUART1SW)
    {
        /* LPUART1CLK Clock is HSI Osc. */
        RCC_Clocks->LPUART1CLK_Frequency = HSI_VALUE;
    }

    /* LPTIM1CLK clock frequency */
    if ((RCC->CFGR6 & RCC_CFGR6_LPTIM1SW) == 0x0)
    {
        /* LPTIM1CLK Clock is PCLK */
        RCC_Clocks->LPTIM1CLK_Frequency = RCC_Clocks->PCLK_Frequency;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPTIM1SW) == RCC_CFGR6_LPTIM1SW_0)
    {
        /* LPTIM1CLK Clock is System Clock */
        RCC_Clocks->LPTIM1CLK_Frequency = RCC_Clocks->SYSCLK_Frequency;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPTIM1SW) == RCC_CFGR6_LPTIM1SW_1)
    {
        /* LPTIM1CLK Clock is LSE Osc. */
        RCC_Clocks->LPTIM1CLK_Frequency = LSE_VALUE;
    }
    else if ((RCC->CFGR6 & RCC_CFGR6_LPTIM1SW) == RCC_CFGR6_LPTIM1SW)
    {
        /* LPTIM1CLK Clock is HSI Osc. */
        RCC_Clocks->LPTIM1CLK_Frequency = HSI_VALUE;
    }

    /* RTCCLK clock frequency */
    if ((RCC->BDCR & RCC_BDCR_RTCSEL) == 0x0)
    {
        /* RTCCLK Clock is none */
        //CC_Clocks->RTCCLK_Frequency = RCC_Clocks->PCLK_Frequency;
    }
    else if ((RCC->BDCR & RCC_BDCR_RTCSEL) == RCC_BDCR_RTCSEL_0)
    {
    ...
    else if ((RCC->BDCR & RCC_BDCR_RTCSEL) == RCC_BDCR_RTCSEL)
    {
...
/**
  ...
  *         This parameter can be any combination of the following values:
  *            @arg RCC_AHB2Periph_EMACC: EMACC clock
  *            @arg RCC_AHB2Periph_TRNG: TRNG clock
...
/**
  ...
  *            @arg RCC_APB2Periph_ADC:   ADC1 clock
...
/**
  ...
  *            @arg RCC_APB1Periph_LPUART1:  LPUART clock ,
...
/**
  ...
  *            @arg RCC_IT_LSEFAIL: LSE fail interrupt
...
/**
  ...
  *            @arg RCC_FLAG_V15PWRRSTF:  V1.5 power domain reset
