...
* @filename:  hk32f0xxa_eval_i2c_ee.h
* @brief:     This file contains all the functions prototypes for
*             the hk32f0xxa_eval_i2c_ee.c firmware driver.
* @author:    AE Team
*******************************************************************************/


/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F0XXA_EVAL_I2C_EE_H
#define __HK32F0XXA_EVAL_I2C_EE_H
...
/** @defgroup HK32F0xxA_EVAL_I2C_EE_Exported_Types
  * @{
  */
...
/** @defgroup HK32F0xxA_EVAL_I2C_EE_Exported_Constants
  * @{
  */
...
/* Uncomment the following line to use the default sEE_TIMEOUT_UserCallback()
   function implemented in hk32f0xxa_eval_i2c_ee.c file.
...
/** @defgroup HK32F0xxA_EVAL_I2C_EE_Exported_Macros
  * @{
  */
/**
  * @}
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
/** @defgroup HK32F0xxA_EVAL_I2C_EE_Exported_Functions
  * @{
  */
...
/* sEE_TIMEOUT_UserCallback() function is called whenever a timeout condition
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in hk32f0xxa_eval_i2c_ee.h file.
...
#endif /*__HK32F0XXA_EVAL_I2C_EE_H */
/**
  * @}
  */
