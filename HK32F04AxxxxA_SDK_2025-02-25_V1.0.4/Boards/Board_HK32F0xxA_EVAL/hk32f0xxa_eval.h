...
* @filename:  hk32f0xxa_eval.h
* @brief:     This file contains definitions for HK32F0xxA_EVAL's Leds, push-buttons
...
#ifndef __HK32F0XXA_EVAL_H
#define __HK32F0XXA_EVAL_H
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL
  * @{
  */
...
/* Exported constants --------------------------------------------------------*/
/** @defgroup HK32F0xxA_EVAL_LOW_LEVEL_Exported_Constants
  * @{
  */

/**
  * @brief  Define for HK32F0xxA_EVAL board
  */
#if !defined (USE_HK32F0xxA_EVAL)
#define USE_HK32F0xxA_EVAL
#endif


/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_LED
  * @{
  */
#define LEDn                             4
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_BUTTON
  * @{
  */
#define BUTTONn                          7
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_COM
  * @{
  */
#define COMn                             1
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_SD_SPI
  * @{
  */
/**
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_W25Q_FLASH_SPI
  * @{
  */
/**
...
#define sFLASH_SPI_SCK_AF                GPIO_AF_8
...
#define sFLASH_SPI_MISO_AF               GPIO_AF_8
...
#define sFLASH_SPI_MOSI_AF               GPIO_AF_8
...
#define sFLASH_CS_GPIO_CLK               RCC_AHBPeriph_GPIOB
#define sFLASH_CS_AF                     GPIO_AF_8
#define sFLASH_CS_SOURCE                 GPIO_PinSource12
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_TSENSOR_I2C
  * @{
  */
/**
...
/** @addtogroup HK32F0xxA_EVAL_LOW_LEVEL_I2C_EE
  * @{
  */
/**
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
/** @defgroup HK32F0xxA_EVAL_LOW_LEVEL_Exported_Functions
  * @{
  */
