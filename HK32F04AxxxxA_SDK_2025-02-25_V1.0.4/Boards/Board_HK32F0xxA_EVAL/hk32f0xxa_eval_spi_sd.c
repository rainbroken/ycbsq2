...
* @filename:  hk32f0xxa_eval_spi_sd.c
* @brief:     This file provides a set of functions needed to manage the SPI SD
*             Card memory mounted on HK32F0xxA-EVAL board.
*             It implements a high level communication layer for read and write
*             from/to this memory. The needed HK32F0xxA hardware resources (SPI and
*             GPIO) are defined in hk32f0xxa_eval.h file, and the initialization is
*             performed in SD_LowLevel_Init() function declared in hk32f0xxa_eval.c
*             file.
...
/** @addtogroup HK32F0xxA_EVAL_SPI_SD
  * @brief      This file includes the SD card driver of HK32F0xxA-EVAL boards.
  * @{
  */
...
/** @defgroup HK32F0xxA_EVAL_SPI_SD_Private_Variables
  * @{
  */
...
/** @defgroup HK32F0xxA_EVAL_SPI_SD_Private_Function_Prototypes
  * @{
  */
/**
  * @}
...
/** @defgroup HK32F0xxA_EVAL_SPI_SD_Private_Functions
  * @{
  */
...
uint8_t SD_WriteByte(uint8_t Data)
{
    ...
    while (SPI_I2SGetFlagStatus(SD_SPI, SPI_I2S_FLAG_TXE) == RESET)
    {
    }
    ...
    while (SPI_I2SGetFlagStatus(SD_SPI, SPI_I2S_FLAG_RXNE) == RESET)
    {
    }
