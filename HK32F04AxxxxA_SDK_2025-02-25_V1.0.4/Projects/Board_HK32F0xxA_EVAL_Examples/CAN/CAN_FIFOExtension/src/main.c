...
/** @addtogroup CAN_FIFOExtension_Example
  * @{
  */
...
#define MESSAGE3   "Send message:"
#define MESSAGE4   "Received message"
...
static void Display_ReceivedMsg(void);
...
int main(void)
{
    ...
    */
    ...
    while (1)
    {
        ...
        if (MsgReceived != 0)
        {
            /* Display received the 6 messages */
            Display_ReceivedMsg();
            MsgReceived = 0;
        }
    }
...
static void Display_TransmittedMsg(uint8_t PushNumber)
{
    ...
    for (DataIndex = 0 ; DataIndex < 6 ; DataIndex++)
    {
        ...
        printf("\r\n Send Message Num%d    = %d            ", DataIndex + 1, TxMessage.Data[0] );
    }
}
...
static void Display_ReceivedMsg(void)
{
    ...
    for (DataIndex = 0 ; DataIndex < 6 ; DataIndex++)
    {
        ...
        printf("\r\n Message received Num%d= %d   ", DataIndex + 1, RxMessage.Data[0]);
    }
}
