...
uint8_t Encryption128Key[16] = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
                                0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c
                               };/* key size 128 bytes */


uint8_t Encryption192Key[24] = {0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52,
                                0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5,
                                0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b
                               }; /* key size 192 bytes */

uint8_t Encryption256Key[32] = {0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe,
...
int main(void)
{
    ...
    */
    ...
    if (AES_ECB_Encrypt(Encryption128Key, 128, PlainText, AES_TEXT_SIZE, Encryptedtext) == SUCCESS)
    {
    ...
    {
        printf("AES ECB 128Keysize Encrypted Fail\r\n");
    }
    ...
    /****************************************/
    /* Encrypt the plaintext message*/
    if (AES_ECB_Encrypt(Encryption192Key, 192, PlainText, AES_TEXT_SIZE, Encryptedtext) == SUCCESS)
    {
        /* Display encrypted Data*/
    ...
    {
        printf("AES ECB 192Keysize Encrypted Fail\r\n");
    }
    ...
    /****************************************/
    /* Encrypt the plaintext message*/
    if (AES_ECB_Encrypt(Encryption256Key, 256, PlainText, AES_TEXT_SIZE, Encryptedtext) == SUCCESS)
    {
        /* Display encrypted Data*/
    ...
    {
        printf("AES ECB 256Keysize Encrypted Fail\r\n");
    }
    ...
    if (AES_ECB_Decrypt( Encryption128Key, 128, Ciphertext, AES_TEXT_SIZE, Decryptedtext) == SUCCESS)
    {
    ...
    /****************************************/
    /* Decrypt the plaintext message  */
    if (AES_ECB_Decrypt( Encryption192Key, 192, Ciphertext, AES_TEXT_SIZE, Decryptedtext) == SUCCESS)
    {
        /* Display decrypted data*/
    ...
    {
        printf("AES ECB 192Keysize Decrypted  Fail\r\n");
    }
    ...
    /****************************************/
    /* Decrypt the plaintext message  */
    if (AES_ECB_Decrypt( Encryption256Key, 256, Ciphertext, AES_TEXT_SIZE, Decryptedtext) == SUCCESS)
    {
        /* Display decrypted data*/
    ...
    {
        printf("AES ECB 256Keysize Decrypted Fail\r\n");
    }
