...
int main(void)
{
    ...
    while (SPI_I2SGetFlagStatus(SPI1, SPI_I2S_FLAG_BSY) == SET)
    {
    ...
    SPI_I2SDMACmd(SPI1, SPI_I2S_DMAReq_Tx, DISABLE);
    ...
    SPI_I2SDMACmd(SPI1, SPI_I2S_DMAReq_Rx, DISABLE);
...
static void I2S_Config(void)
{
    ...
    /* Enable the I2S1 RX DMA request */
    SPI_I2SDMACmd(SPI1, SPI_I2S_DMAReq_Rx, ENABLE);
