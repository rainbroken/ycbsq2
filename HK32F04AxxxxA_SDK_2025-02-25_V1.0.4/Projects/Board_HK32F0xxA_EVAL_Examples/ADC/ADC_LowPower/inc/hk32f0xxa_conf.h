...
#define SYSCLK_SOURCE    SYSCLK_SRC_HSI56M

// #define VECT_TAB_SRAM
#define VECT_TAB_OFFSET  0x0 /*!< Vector Table base offset field. This value must be a multiple of 0x200. */

#if(SYSCLK_SOURCE==SYSCLK_SRC_PLL)
//#define SYSCLK_HSE8M_PLL_FREQ_24MHz       24000000     //RCC_CFGR4.PPSS = 0(ѡ��HSE) PREDIV = 1  PLLSRC = 1  PLLMUL = 3  8M/1 * 3 = 24M
//#define SYSCLK_HSE8M_PLL_FREQ_48MHz       48000000     //RCC_CFGR4.PPSS = 0(ѡ��HSE) PREDIV = 1  PLLSRC = 1  PLLMUL = 6  8M/1 * 6 = 48M
//#define SYSCLK_HSE8M_PLL_FREQ_72MHz       72000000     //RCC_CFGR4.PPSS = 0(ѡ��HSE) PREDIV = 1  PLLSRC = 1  PLLMUL = 9  8M/1 * 9 = 72M
#define SYSCLK_HSE8M_PLL_FREQ_96MHz         96000000     //RCC_CFGR4.PPSS = 0(ѡ��HSE) PREDIV = 1  PLLSRC = 1  PLLMUL = 12 8M/1 * 3 = 96M

//#define SYSCLK_HSI_PLL_FREQ_48MHz         48000000     //HSI=8M RCC_CFGR4.PPSS = 0(ѡ��HSE) PREDIV = 1  PLLSRC = 0��HSI/2�� PLLMUL = 12 4M/1 * 12 = 48M
//#define SYSCLK_HSI_PLL_FREQ_64MHz         64000000     //HSI=8M RCC_CFGR4.PPSS = 1(ѡ��HSI) PREDIV = 1  PLLSRC = 1          PLLMUL = 8  8M/1 * 8 = 64M
//#define SYSCLK_HSI_PLL_FREQ_72MHz         72000000     //HSI=8M RCC_CFGR4.PPSS = 1(ѡ��HSI) PREDIV = 1  PLLSRC = 1          PLLMUL = 9  8M/1 * 9 = 72M
//#define SYSCLK_HSI_PLL_FREQ_96MHz         96000000     //HSI=8M RCC_CFGR4.PPSS = 1(ѡ��HSI) PREDIV = 1  PLLSRC = 1          PLLMUL = 12 8M/1 * 8 = 96M
