...
******************************例程详细描述*****************************
功能描述:
1. 展示了怎么配置TIM1产生三路互补PWM输出，并插入死区时间，并且使能break功能；
2. 输出的PWM波形频率为17.57KHz；
3. channel 1 占空比为50 % ，channel 1N占空比为50 % ；
4. channel 2 占空比为25 % ，channel 2N占空比为75 % ；
5. channel 3 占空比为12.5 % ，channel 3N占空比为87.5 % ；
时钟配置:
