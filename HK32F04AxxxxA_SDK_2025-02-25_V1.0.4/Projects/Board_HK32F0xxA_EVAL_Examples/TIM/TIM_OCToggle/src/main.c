...
static void TIM_Config(void)
{
    ...
    /* ---------------------------------------------------------------------------
      ...
      In this example TIM3 input clock (TIM3CLK) is set to APB1 clock (PCLK1).
        => TIM3CLK = PCLK1 = 56 MHz

       CC1 update rate = TIM3 counter clock / CCR1_Val = 1367.1 Hz
       ==> So the TIM3 Channel 1 generates a periodic signal with a
           frequency equal to 683.5 Hz.

       CC2 update rate = TIM3 counter clock / CCR2_Val = 2734.3 Hz
       ==> So the TIM3 Channel 2 generates a periodic signal with a
           frequency equal to 1367.1 Hz.

       CC3 update rate = TIM3 counter clock / CCR3_Val = 5468.6 Hz
       ==> So the TIM3 Channel 3 generates a periodic signal with a
           frequency equal to 2734.3 Hz.

       CC4 update rate = TIM3 counter clock / CCR4_Val = 10937.2 Hz
       ==> So the TIM3 Channel 4 generates a periodic signal with a
           frequency equal to 5468.6 Hz.
    --------------------------------------------------------------------------- */
