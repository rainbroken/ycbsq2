...
static void COMP_Config(void)
{
    ...
    /* COMP1 Init: the higher threshold is set to VREFINT ~ 1.2V
    ...
    /* COMP2 Init: the lower threshold is set to VREFINT/4 ~ 1.2 / 4 ~ 0.3 V
       but can be changed to other available possibilities */
    ...
    /* Enable COMP1: the higher threshold is set to VREFINT ~ 1.2 V */
    COMP_Cmd(COMP_Selection_COMP1, ENABLE);

    /* Enable COMP2: the lower threshold is set to VREFINT/4 ~ 0.3 V */
