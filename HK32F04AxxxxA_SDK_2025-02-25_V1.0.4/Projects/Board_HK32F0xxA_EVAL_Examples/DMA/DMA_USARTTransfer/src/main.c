...
uint32_t DMA_WaitTime = 0x00000000;
...
int main(void)
{
    ...
    */
    ...
    /* DMA remap Channel7 to USART2 Rx/Tx */
    ...
    while (!DMA_GetFlagStatus(DMA1_FLAG_TC2) && (DMA_WaitTime != DMA_TIMEOUT))
    {
        DMA_WaitTime++;
    }
    ...
    while (!DMA_GetFlagStatus(DMA1_FLAG_TC7) && (DMA_WaitTime != DMA_TIMEOUT))
    {
        DMA_WaitTime++;
    }
    ...
    while (!DMA_GetFlagStatus(DMA1_FLAG_TC6) && (DMA_WaitTime != DMA_TIMEOUT))
    {
        DMA_WaitTime++;
    }
    ...
    while (!DMA_GetFlagStatus(DMA1_FLAG_TC3) && (DMA_WaitTime != DMA_TIMEOUT))
    {
        DMA_WaitTime++;
    }
