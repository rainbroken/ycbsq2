...
int main(void)
{
    ...
    while (1)
    {
        ...
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Rx, ENABLE);
        ...
        while ((SPI_I2SGetFlagStatus(SPIx, SPI_I2S_FLAG_TXE) == RESET) && (TimeOut != 0x00))
        {
        }
        ...
        while ((SPI_I2SGetFlagStatus(SPIx, SPI_I2S_FLAG_BSY) == SET) && (TimeOut != 0x00))
        {
        }
        ...
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Rx, DISABLE);
    ...
    while (1)
    {
        ...
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Rx, ENABLE);
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Tx, ENABLE);
        ...
        /* Disable the SPI Rx and Tx DMA requests */
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Rx, DISABLE);
        SPI_I2SDMACmd(SPIx, SPI_I2S_DMAReq_Tx, DISABLE);
