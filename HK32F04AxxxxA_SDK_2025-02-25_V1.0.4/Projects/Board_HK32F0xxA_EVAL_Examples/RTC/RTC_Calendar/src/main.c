...
void RTC_TimeRegulate(void)
{
    ...
    {
        //uint32_t tmp_input = 0xff;

        /* Set Date Week/Date/Month/Year */
        RTC_DateStructure.RTC_WeekDay = 06;
...
void RTC_TimeShow(void)
{
    ...
    printf("\n\r  %0.4d-%0.2d-%0.2d %0.2d:%0.2d:%0.2d  Week(%d)\n\r",
           (RTC_DateStructure.RTC_Year + 2000), RTC_DateStructure.RTC_Month, RTC_DateStructure.RTC_Date,
