...
__IO uint8_t UsartTransactionType = LPUART_TRANSACTIONTYPE_CMD;
__IO uint8_t UsartMode = LPUART_MODE_TRANSMITTER;
...
int main(void)
{
    ...
    /* LPUART configuration for printf */
    ...
    while (1)
    {
        TxIndex = 0x00;
        RxIndex = 0x00;
        UsartTransactionType = LPUART_TRANSACTIONTYPE_CMD;
        UsartMode = LPUART_MODE_RECEIVER;
        ...
        {
            UsartMode = LPUART_MODE_TRANSMITTER;
            ...
            /* send cmd to slave*/
            /* Enable the LPUARTx transmit data register empty interrupt */
            ...
            /* LPUART sends the data */
            UsartTransactionType = LPUART_TRANSACTIONTYPE_DATA;
            TxIndex = 0x00;
            RxIndex = 0x00;
            /* Enable the LPUARTx transmit data register empty interrupt */
            LPUART_ITConfig(LPUART1, LPUART_IT_TXE, ENABLE);
        ...
        {
            /* Wait until LPUART receives the command  or time out */
            TimeOut = USER_TIMEOUT;
            ...
            /* Enable the LPUARTx transmit data register empty interrupt */
            LPUART_ITConfig(LPUART1, LPUART_IT_TXE, ENABLE);
            /* Wait until LPUART sends the ACK command or time out*/
            TimeOut = USER_TIMEOUT;
