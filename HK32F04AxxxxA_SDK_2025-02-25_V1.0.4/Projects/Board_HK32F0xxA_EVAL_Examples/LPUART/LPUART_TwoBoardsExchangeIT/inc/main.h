...
/* LPUART Mode Selected */
#define LPUART_MODE_TRANSMITTER           0x00
#define LPUART_MODE_RECEIVER              0x01

/* LPUART Transaction Type use in slave to slect phase */
#define LPUART_TRANSACTIONTYPE_CMD        0x00
#define LPUART_TRANSACTIONTYPE_DATA       0x01
