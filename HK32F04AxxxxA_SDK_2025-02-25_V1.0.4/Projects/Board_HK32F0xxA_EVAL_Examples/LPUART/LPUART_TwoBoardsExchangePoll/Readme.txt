...
******************************例程详细描述*****************************
功能描述:
此示例提供了一个使用Joystick按钮控制两块板间LPUART沦陷通信的小型应用程序
...
-软件说明
在板A上(需要屏蔽宏定义#define LPUART_BoardB)，在按钮区处按下：
...
-LPUART Board B(需要打开宏定义#define LPUART_BoardB)
将接收到的字节数与定义的字节数进行比较
