...
#define FLASH_PAGES_TO_BE_PROTECTED    (OB_WRP_Pages20to23 | OB_WRP_Pages44to47 | OB_WRP_Pages60to63 | OB_WRP_Pages100to103)
...
int main(void)
{
    ...
    if ((WRPR_Value | (~FLASH_PAGES_TO_BE_PROTECTED)) != 0xFFFFFFFF )
    {
        ...
        FLASHStatus = FLASH_OBErase();

        /* Check if there is write protected pages */
        if (ProtectedPages != 0x0)
        {
            /* Restore write protected pages */
            FLASHStatus = FLASH_OBEnableWRP(ProtectedPages);
        }
